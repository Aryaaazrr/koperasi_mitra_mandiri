                                        ...
                                        <div class="row">
                                            <div class="col-15">
                                                <div class="numbers">
                                                    ...
                                                    <div class="d-flex flex-column align-items-start gap-1">
                                                        <h5 class="mb-2 mt-3">Rp
                                                            {{ number_format($totalSimpananPokok, 2, ',', '.') }}</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-15">
                                                <div class="numbers">
                                                    ...
                                                    <div class="d-flex flex-column align-items-start gap-1">
                                                        <h5 class="mb-2 mt-3">Rp
                                                            {{ number_format($totalSimpananWajib, 2, ',', '.') }}</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-15">
                                                <div class="numbers">
                                                    ...
                                                    <div class="d-flex flex-column align-items-start gap-1">
                                                        <h5 class="mb-2 mt-3">Rp
                                                            {{ number_format($totalSimpananSukarela, 2, ',', '.') }}</h5>
