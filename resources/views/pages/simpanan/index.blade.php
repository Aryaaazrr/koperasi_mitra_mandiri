            ...
            <script>
                $(document).ready(function() {
                    $('#myTable').DataTable({
                        ...
                        responsive: true,
                        serverSide: true,
                        ajax: "{{ route('superadmin.simpanan') }}",
                        columns: [{
                                data: 'DT_RowIndex',
                                name: 'DT_RowIndex'
                            },
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    return '<div class="row justify-content-center">' +
                                        '<div class="col-auto">' +
                                        '<a href="{{ route('superadmin.simpanan.show', '') }}/' + data
                                        .id_simpanan +
                                        '" style="font-size: 10pt" class="btn btn-secondary m-1 edit-btn" ' +
                                        'data-id="' + data.id_simpanan +
                                        '">Lihat</a>' +
                                        '<div class="col-auto">' +
                                        '<a href="{{ route('superadmin.simpanan.destroy', '') }}/' + data
                                        .id_simpanan +
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    return '<div class="row justify-content-center">' +
                                        '<div class="col-auto">' +
                                        '<a href="{{ route('admin.simpanan.show', '') }}/' + data
                                        .id_simpanan +
                                        '" style="font-size: 10pt" class="btn btn-secondary m-1 edit-btn" ' +
                                        'data-id="' + data.id_simpanan +
                                        '">Lihat</a>' +
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(data) {
                                    return '<div class="row justify-content-center">' +
                                        '<div class="col-auto">' +
                                        '<a href="{{ route('simpanan.show', '') }}/' + data
                                        .id_simpanan +
                                        '" style="font-size: 10pt" class="btn btn-secondary m-1 edit-btn" ' +
                                        'data-id="' + data.id_simpanan +
                                        '">Lihat</a>' +
